...
//////////////////////////////////////////////////////////////////////////////////////////////////
 	...
 	if (argc < 9) {
 	    opserr << "WARNING insufficient arguments\n";
 	    printCommand(argc,argv);
 	    opserr << "Want: uniaxialMaterial QzLiq1 tag? qzType? qult? z50? dashpot? solidElem1? solidElem2?" << endln;
		opserr << "or: uniaxialMaterial QzLiq1 tag? qzType? qult? z50? dashpot? -timeSeries seriesTag?" << endln;
 	    return 0;
 	}
