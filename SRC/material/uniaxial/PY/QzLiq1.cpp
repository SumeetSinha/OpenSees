...
void* QPS_QzLiq1()
{
	...
	opserr << "Want: uniaxialMaterial QzLiq1 tag? qzType? qult? z50? suction? dashpot? solidElem1? solidElem2?\n";
	opserr << "or: uniaxialMaterial QzLiq1 tag? qzType? qult? z50? suction? dashpot? -timeSeries seriesTag?\n";
	return 0;
    }
